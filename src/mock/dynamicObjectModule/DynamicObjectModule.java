...
import mock.dynamicObjectModule.entities.Character.DIRECTIONS;
import mock.dynamicObjectModule.entities.Item;
import mock.dynamicObjectModule.entities.Sprite;
import mock.tcpClientModule.MoveCodes;
...
public class DynamicObjectModule {
	...
	public void addVirtualCharacter(int clientNumber) {
		...
		Character character = new Character(clientNumber, Character.DEFAULT_X, Character.DEFAULT_Y,
				Character.DEFAULT_DIRECTION, Character.DEFAULT_SPEED);
